...
function render_row(cookie){var row=jQuery("<tr></tr>");for(const key in cookie){if(key==='can_be_blocked'){if(cookie[key])
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://www.loomis.no/wp-content/plugins/ct-ultimate-gdpr/assets/js/cookie-list.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://www.loomis.no/wp-content/plugins/responsive-menu-pro/public/js/noscroll.js\n- Error message: "+ e.message);}
